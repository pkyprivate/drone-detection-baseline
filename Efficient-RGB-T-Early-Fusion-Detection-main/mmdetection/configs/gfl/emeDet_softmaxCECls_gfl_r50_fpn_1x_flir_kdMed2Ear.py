_base_ = './gfl_r50_fpn_1x_flir_kdMed2Ear.py'
load_from = '/home/zx/rgbx-distillation/code/mmdetection-main/runs/train/FLIR_coreKD_rgbtEarly_zxModifiedStem_gfl_r101tor50_fpn_1x_bs4_clipTransfer/epoch_12.pth'
model = dict(
