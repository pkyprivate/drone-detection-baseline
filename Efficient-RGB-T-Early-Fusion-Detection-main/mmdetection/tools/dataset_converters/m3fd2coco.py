...
label_ids = dict([(k, v) for (v, k) in enumerate(['People', 'Car', 'Bus', 'Motorcycle', 'Lamp', 'Truck'])])
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert M3FD annotations to mmdetection format')
    parser.add_argument('--in_path', default='/home/zx/rgbx-distillation/datasets/detection/M3FD_zxSceneSplit_yolov5Format',
                        help='M3FD path')
    parser.add_argument('--out-dir', default='/home/zx/rgbx-distillation/datasets/detection/M3FD_zxSceneSplit_yolov5Format',
                        help='output path')
